...
namespace spa
{
    public partial class CatalogForAdminForm : Form
    {
        public static int id;
        public CatalogForAdminForm()
        {
            InitializeComponent();
        ...
        {
            this.Close();
            AddProductInCatalogForm addProductInCatalogForm = new AddProductInCatalogForm();
            addProductInCatalogForm.Show();
        }

        private void CatalogForAdminForm_Load(object sender, EventArgs e)
        {
